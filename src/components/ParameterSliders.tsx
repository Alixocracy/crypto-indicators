...
const ParameterSliders = ({ selectedIndicators, parameters, onParameterChange }: ParameterSlidersProps) => {
  ...
  return (
    <div className="gradient-border rounded-xl p-5 space-y-5 animate-fade-in" style={{ animationDelay: '0.2s' }}>
      ...
      <p className="text-xs text-muted-foreground">
        Adjust settings and see how they affect the indicators. No right or wrong — just explore!
      </p>
